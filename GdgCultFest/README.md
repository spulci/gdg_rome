...
1. Add your API method to `src/main/java/org/gdgrome/lab/gdgcultfest/YourFirstAPI.java`.

1. Optional step: These sub steps are not required but you need this
   if you want to have auth protected methods.

    1. Update the values in `src/main/java/org/gdgrome/lab/gdgcultfest/Constants.java`
